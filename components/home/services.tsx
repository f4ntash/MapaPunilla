...
export function Services() {
  return (
    <SectionWrapper>
      <SectionHeader
        badge="Servicios"
        title="Todo lo que necesitás para atraer más clientes"
        subtitle="Soluciones simples para negocios turísticos. Cada servicio está pensado para darte resultados que se ven."
      />
