    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="container relative z-10 text-center">
        <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-4 md:mb-6 max-w-3xl mx-auto leading-[1.1]">
          ¿Querés más consultas para tu negocio en Punilla?
        </h2>
        <p className="text-base md:text-lg lg:text-xl text-white/90 max-w-2xl mx-auto mb-8 md:mb-10">
          Pedinos un diagnóstico gratis. Revisamos tu presencia online y te decimos que conviene mejorar primero para ganar visibilidad, confianza y reservas.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4">
          <Button
            ...
            onClick={() =>
              window.open(
                config.whatsapp.link("Hola! Quiero pedir un diagnóstico gratis"),
                "_blank"
              )
            }
          ...
          <Button
            ...
            onClick={() =>
              window.open(
                config.whatsapp.link("Hola! Quiero más consultas para mi negocio"),
                "_blank"
              )
            }
